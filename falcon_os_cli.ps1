...
Write-Output $current_path
Writ-Output "That is what you're deleting, be carefull which files you delete."
...
if ($delconfirm -eq "no") {Write-Ooutput "Please stop, and start the terminal again to continue."}
}
